// Ödev 1  JavaScript ile istediğiniz kadar sayı parametre gönderebileceğiniz bir fonksiyon yazınız.
...
function findPrime(...numbers) {
    ...
    console.log(numbers + " sayıları içinde bulunan:")
    console.log("Asal Sayılar: " + primeNumbers)
    console.log("Asal Olmayan Sayılar: " + nonPrimeNumbers)
}
findPrime(2, 19, 24, 37, 14, 12, 11, 1, -12)

// Ödev2  Parametre olarak girilen iki sayının arkadaş sayılar olup olmadığını bulan programı yazınız.
...
//Ödev 4 - 1000 'e kadarki tüm asal sayıları listeleyen programı
